        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="uploads/66e8000d1cdf1top-06-dien-thoai-chup-anh-dep-cho-tin-do-me-song-ao-thumbnail.jpg">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <?php 
                                foreach ($result1 as $value) {
                                    ?>
                                    <li data-filter=".<?php echo $value['slug']?>"><?php echo $value['name']?></li>
